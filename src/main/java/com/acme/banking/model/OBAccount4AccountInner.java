...
@Schema(name = "OBAccount4_Account_inner", description = "Provides the details to identify an account.")
@JsonTypeName("OBAccount4_Account_inner")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2023-01-05T12:36:05.734327300Z[UTC]")
public class OBAccount4AccountInner {
  ...
  public OBAccount4AccountInner schemeName(String schemeName) {
  ...
  */
  ...
  public OBAccount4AccountInner identification(String identification) {
  ...
  */
  ...
  public OBAccount4AccountInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  */
  ...
  public OBAccount4AccountInner secondaryIdentification(String secondaryIdentification) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    OBAccount4AccountInner obAccount4AccountInner = (OBAccount4AccountInner) o;
    return Objects.equals(this.schemeName, obAccount4AccountInner.schemeName) &&
        Objects.equals(this.identification, obAccount4AccountInner.identification) &&
        Objects.equals(this.name, obAccount4AccountInner.name) &&
        Objects.equals(this.secondaryIdentification, obAccount4AccountInner.secondaryIdentification);
  }
  ...
  public String toString() {
    ...
    sb.append("class OBAccount4AccountInner {\n");
