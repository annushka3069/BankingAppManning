...
@Schema(name = "OBAccount6", description = "Unambiguous identification of the account to which credit and debit entries are made.")
...
public class OBAccount6 {
  ...
  */
  ...
  public OBAccount6 account(List<OBAccount4AccountInner> account) {
    this.account = account;
    return this;
  }

  public OBAccount6 addAccountItem(OBAccount4AccountInner accountItem) {
